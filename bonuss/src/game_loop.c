...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/03/08 13:59:42 by mferracc          #+#    #+#             */
/*   Updated: 2023/03/09 08:38:42 by mferracc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	is_monster(t_game *game, int i, int j, char dir)
{
	char	**map;

	map = game->map;
	if (dir == 'L' && map[i][j - 1] == 'M')
		return (1);
	else if (dir == 'R' && map[i][j + 1] == 'M')
		return (1);
	else if (dir == 'U' && map[i - 1][j] == 'M')
		return (1);
	else if (dir == 'D' && map[i + 1][j] == 'M')
		return (1);
	return (0);
}
...
int	check_move(t_game *game, int i, int j, char dir)
{
	...
	else if (is_monster(game, i, j, dir))
		quit_game(game, "You lost!\n");
	return (0);
}
