...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/03/08 14:17:06 by mferracc          #+#    #+#             */
/*   Updated: 2023/03/09 08:40:15 by mferracc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	load_img(t_game *game)
{
	...
	if (!game->open_door)
		return (0);
	game->monster = mlx_xpm_file_to_image(game->mlx_ptr, \
			"./textures/monster/pm3.xpm", &x, &x);
	if (!game->monster)
		return (0);
	load_anim(game);
	return (1);
